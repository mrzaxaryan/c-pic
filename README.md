...
bin/
  windows/
    ...
    windows_x86_64.elf / .bin / ...
    windows_arm32.elf / .bin / ...
    windows_aarch64.elf / .bin / ...
  linux/
    linux_i386.elf / .bin / ...
    linux_x86_64.elf / .bin / ...
    linux_aarch64.elf / .bin / ...
```
...
- **Windows‑style payloads** (code expects Windows user‑mode structures such as the PEB)
  ...
  - 64‑bit x86‑64 (`windows_x86_64`, triple `x86_64-unknown-linux-gnu`)
  - 32‑bit ARMv7 (`windows_arm32`, triple `thumbv7a-none-linux-gnueabi`)
  - 64‑bit AARCH64 (`windows_aarch64`, triple `aarch64-unknown-linux-gnu`)
- **Linux payloads**
  - 32‑bit x86 (`linux_i386`, triple `i386-unknown-linux-gnu`)
  - 64‑bit x86‑64 (`linux_x86_64`, triple `x86_64-unknown-linux-gnu`)
  - 64‑bit AARCH64 (`linux_aarch64`, triple `aarch64-unknown-linux-gnu`)
